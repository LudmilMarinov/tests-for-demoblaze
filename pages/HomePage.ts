...
export class HomePage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.categoryComponent = new CategoryComponent(this.page.locator(".list-group"));
        this.productGrid = new ProductGridComponent(this.page.locator("#tbodyid"));
        this.nextButton = this.page.locator("#next2");
        this.loginModal = new LoginModalComponent(this.page.locator("[class='modal-content']:visible"));
    }
    ...
    async login(username: string, password: string) {
        ...
        await this.navBar.navMenu.getNavMenuItemByText(`Welcome ${username}`).waitFor();
    }
}
